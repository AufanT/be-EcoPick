    ...
    await queryInterface.bulkInsert('Products', [
      {
        ...
        main_material: 'Canvas Organik',
        is_biodegradable: true,
        recycled_content: 80,
        packaging_type: 'Kertas Daur Ulang',
        is_reusable: true,
      ...
      },
      {
        ...
        origin: 'Indonesia',
        main_material: 'Stainless Steel 304',
        is_biodegradable: false,
        recycled_content: 50,
        packaging_type: 'Karton Daur Ulang',
        is_reusable: true,
        has_eco_certification: true,
        is_eco_friendly_ml: true,
        is_eco_friendly_admin: true,
      ...
      },
      {
        ...
        main_material: 'Madu Murni',
        is_biodegradable: true,
        recycled_content: 0,
        packaging_type: 'Kaca Daur Ulang',
        is_reusable: true,
        has_eco_certification: true,
        is_eco_friendly_ml: true,
        is_eco_friendly_admin: true,
